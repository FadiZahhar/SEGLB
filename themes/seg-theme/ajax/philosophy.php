...
$icons = $dynamic_featured_image->get_featured_images($parents[1]->ID);
...
$content = explode("<br/>",$parents[1]->post_content);
?>
<head>
...
<div class="grids-slider-grid-row2">
  <div class="grids-slider-grid-row2-grid1" style="width:30%">
    ...
    <ul class="menu">
      <li onclick="document.location.href='#aboutus'"><?= $parents[0]->post_title ?></li>
      <li class="current"><?= $parents[1]->post_title ?></li>
  ...
  <div class="grids-slider-grid-row2-grid2" style="width:65%;padding-top:20px;">
